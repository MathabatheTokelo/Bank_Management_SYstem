...
//function to retrieve and change existing accounts
void see(void){
    FILE *ptr;
    int test=0,rate;
    int choice;
...
void close(void){
    printf("\n\n\n\nThis Project is developed by Mathabathe Tokelo!");
    }
...
int main(){
    ...
    char pass[10],password[10]="tokelo";    //Password to use program
    int i=0;
